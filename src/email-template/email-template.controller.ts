...
export class EmailTemplateController {
  ...
  @Post("create")
  create(@Body() createEmailTemplateDto: CreateEmailTemplateDto, @Req() request: Request & { user: Partial<User> }) {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateEmailTemplateDto: UpdateEmailTemplateDto, @Req() request: Request & { user: Partial<User> }) {
    const user = request.user;
    return this.emailTemplateService.update(id, updateEmailTemplateDto, user);
  }

  @Delete(':id')
  remove(@Param('id') id: string, @Req() request: Request & { user: Partial<User> }) {
    const user = request.user;
